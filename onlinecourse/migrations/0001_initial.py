# Generated by Django 3.1.3 on 2023-07-01 12:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('note', models.TextField(verbose_name='Примечание')),
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course', to='onlinecourse.course', verbose_name='Курс')),
            ],
        ),
        migrations.CreateModel(
            name='Lesson',
        ...
        migrations.AddField(
            model_name='choice',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='onlinecourse.question', verbose_name='Вариант ответа'),
        ),
    ]
